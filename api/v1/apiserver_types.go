...
type ApiserverSpec struct {
	...
	// The Container Image(must not be empty)
...
type ApiserverStatus struct {
	...
	// Number of replicas currently running and ready
	Replicas int32 `json:"replicas"`

	// The image currently running in the pods
	Image string `json:"image"`

	// The port the service is exposing
